...
public class DeclarePageTest {
	...
	public void setUp() throws Exception {
		...
		submitPage = new ReviewPage(driver);
		// repeat
		...
		costDetailsPage.getRemarks().sendKeys("remark 4");
		// upload
	...
	@Test
	public void declarePageTest_Positive01() {
		// main test logic
		...
		//submitPage.waitForReady();
		//Assert.assertTrue(submitPage.isPageDisplayed());
	}
